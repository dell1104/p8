...
from utils import (
    calcular_hash_sha256, clasificar_tipo_archivo, generar_nombre_archivo_seguro,
    guardar_hash_archivo, log_evento, validar_archivo_audio, parsear_transcripciones_txt
)
