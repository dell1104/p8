...
from utils import (
    calcular_hash_sha256, validar_archivo_audio, parsear_transcripciones_txt,
    log_evento
)
...
def transcribir_audio():
    ...
    try:
        ...
        if not validar_archivo_audio(archivo.filename):
        ...
        try:
            # Calcular hash
            hash_sha256 = calcular_hash_sha256(ruta_temporal)
            if not hash_sha256:
...
def cargar_transcripciones_existentes(sesion_id):
    ...
    try:
        ...
        datos_parseados = parsear_transcripciones_txt(contenido)
...
def upload_audio():
    ...
    try:
        ...
        hash_archivo = calcular_hash_sha256(ruta_archivo)
...
def upload_archivo_caso():
    ...
    try:
        ...
        from utils import calcular_hash_sha256
        hash_archivo = calcular_hash_sha256(ruta_archivo)
        tipo_archivo = clasificar_tipo_archivo(nombre_archivo)
